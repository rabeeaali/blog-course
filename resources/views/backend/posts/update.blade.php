<x-app-admin-layout>
    <div class="container mx-auto px-6 py-8">
        <div class="flex justify-between items-center">
            <h3 class="text-gray-700 text-3xl font-medium">Update A New User</h3>
                        ...
                        <div class="col-span-6">
                            ...
                            <div class="mt-2 flex items-center" x-data="imageData()">
                                <div>
                                    ...
                                    <div>
                                        <img class="inline-block h-32 w-32 object-contain rounded"
                                            src="{{ $post->image_path }}">
                                    </div>
